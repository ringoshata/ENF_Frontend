              ...
              <div>
                <el-dropdown trigger="click">
                  <el-button
                    ...
                    type="primary"
                    plain
                    :disabled="totalRewardETH[item.code] == 0"
                  >
                    Claim Reward<i class="el-icon-arrow-down el-icon--right"></i>
                  </el-button>
                  <!-- <span class="el-dropdown-link">
                    Claim Reward<i class="el-icon-arrow-down el-icon--right"></i>
                  </span> -->
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item><div @click="claim(item, false)">Claim to Token</div></el-dropdown-item>
                    <el-dropdown-item><div @click="claim(item, true)">Claim to {{item.code}}</div></el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
                <!-- <el-button
                  style="float: right"
              ...
              <el-col :span="10" :offset="3">
                ...
                <el-dropdown trigger="click">
                  <el-button
                    ...
                    plain
                  >
                    Withdraw<i class="el-icon-arrow-down el-icon--right"></i>
                  </el-button>
                  <!-- <span class="el-dropdown-link">
                    Claim Reward<i class="el-icon-arrow-down el-icon--right"></i>
                  </span> -->
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item><div @click="withdrawItem(item, 0)">Withdraw without Claim</div></el-dropdown-item>
                    <el-dropdown-item :disabled="totalRewardETH[item.code] == 0"><div @click="withdrawItem(item, 1)">Withdraw and Claim to Token</div></el-dropdown-item>
                    <el-dropdown-item :disabled="totalRewardETH[item.code] == 0"><div @click="withdrawItem(item, 2)">Withdraw and Claim to {{item.code}}</div></el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
              </el-col>
            </el-row>
...
import LowRiskMixinFarm from "../../components/mixins/LowRiskMixinFarm";
export default {
  name: "LowRiskNFarm",
  mixins: [LowRiskMixinFarm],
  components: {
    DialogForm,
    EchartsLine,
    CffTableNew,
