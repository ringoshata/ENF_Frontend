        ...
        <div class="body">
          <el-row>
            ...
            <el-col :span="9">
              ...
              ><br />
              <span class="spanText" v-if="item.code === 'USDC'">
                ≈
              ...
              <span class="bom_li"
                ...
                >
                  <div slot="content">
                    ...
                    <br />
                    2.CRV price fluctuates, so Accu Yield fluctuates too.
                  </div>
          ...
          <el-row>
            ...
            <el-col :span="9">
              <span class="bom_li">30 Days APY</span><br />
              <span class="spanText">{{
        ...
        <div class="body_text">
          <div class="btcwbtc">
            <span class="bom_li">
              ...
              <span>{{ item.code !== "USDC" ? item.code : selectConfirm }}</span>
            </span>
          </div>
          <div class="maxinput">
            <div>
              ...
              >
                <template slot="append">
                  <span
                    :style="{
                      'margin-right': item.code !== 'USDC' ? '0px' : '30px',
                    }"
                    class="Max"
                    v-show="Max === 1"
...
import HighRiskMixinNew from "../../components/mixins/HighRiskMixinNew";
export default {
  name: "HighRiskNewH5",
  mixins: [HighRiskMixinNew],
  components: {
    DialogForm,
    EchartsLine,
    CffTableNew,
